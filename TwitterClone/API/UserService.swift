...
struct UserService {
    ...
    func fecthUserStats(uid: String, completion: @escaping(UserRelationStats) -> Void) {
    ...
    func updateProfileImage(image: UIImage, completion: @escaping(URL?) -> Void) {
        ...
        ref.putData(imageData, metadata: nil) { meta, erro in
    ...
    func fetchUser(withUser user: String, completion: @escaping(User) -> Void) {
        REF_USER_USERNAMES.child(user).observeSingleEvent(of: .value) { snapshot in
